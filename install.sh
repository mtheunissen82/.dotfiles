...
sudo apt-get install -y vim vim-gnome neovim curl wget git silversearcher-ag tmux nfs-common samba-common-bin smbclient cifs-utils xclip fonts-powerline htop tree pass
